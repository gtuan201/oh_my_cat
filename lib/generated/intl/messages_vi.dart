...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    "addWidgetToHomeScreen": MessageLookupByLibrary.simpleMessage(
      "Hướng dẫn thêm widget ra màn hình chính",
    ),
    "add_daily_reminder": MessageLookupByLibrary.simpleMessage(
      "Thêm nhắc nhở hàng ngày",
    ),
    "add_mood_log": MessageLookupByLibrary.simpleMessage(
    ...
    "authentication_cancelled": MessageLookupByLibrary.simpleMessage(
      "Xác thực bị hủy bỏ",
    ),
    ...
    "backup_restore": MessageLookupByLibrary.simpleMessage(
      "Sao lưu & Khôi phục",
    ),
    "backup_restore_message": MessageLookupByLibrary.simpleMessage(
      "Vui lòng đăng nhập vào tài khoản cá nhân của bạn trong [Sao lưu và khôi phục] và sao lưu dữ liệu của bạn, trong trường hợp bạn quên mật khẩu hoặc mất dữ liệu.",
    ),
    ...
    "cannot_delete": MessageLookupByLibrary.simpleMessage(
      "Không thể xoá mục này",
    ),
    ...
    "deleteThisItem": MessageLookupByLibrary.simpleMessage("Xóa mục này?"),
    ...
    "delete_ohmycat_data": MessageLookupByLibrary.simpleMessage(
      "2. Xoá dữ liệu OhMyCat khỏi thiết bị của bạn",
    ),
    "deleted_success": MessageLookupByLibrary.simpleMessage("Đã xoá"),
    "deleting_data": MessageLookupByLibrary.simpleMessage(
      "Đang xoá dữ liệu...",
    ),
    ...
    "existingBackup": MessageLookupByLibrary.simpleMessage(
      "Bản sao lưu hiện có",
    ),
    "existing_backups": MessageLookupByLibrary.simpleMessage(
      "Bản sao lưu hiện có",
    ),
    ...
    "howToAddEmotionDiary": MessageLookupByLibrary.simpleMessage(
      "Cách để thêm nhật ký cảm xúc?",
    ),
    "howToBackupData": MessageLookupByLibrary.simpleMessage(
      "Sao lưu dữ liệu thế nào?",
    ),
    "howToChangeEmotionIcon": MessageLookupByLibrary.simpleMessage(
      "Cách để thay đổi biểu tượng cảm xúc?",
    ),
    ...
    "login_then_restore_data": MessageLookupByLibrary.simpleMessage(
      "Trước tiên hãy đăng nhập vào tài khoản của bạn, sau đó khôi phục dữ liệu của bạn từ Bản sao lưu hiện có mới nhất.",
    ),
    ...
    "mood_statistics": MessageLookupByLibrary.simpleMessage(
      "Thống kê tâm trạng",
    ),
    ...
    "noRecords": MessageLookupByLibrary.simpleMessage("Không có bản ghi nào"),
    "no_backup_data": MessageLookupByLibrary.simpleMessage(
    ...
    "relaxing_sounds": MessageLookupByLibrary.simpleMessage(
      "Âm thanh thư giãn",
    ),
    "reminder_backup": MessageLookupByLibrary.simpleMessage("Nhắc nhở sao lưu"),
    "reminder_time": MessageLookupByLibrary.simpleMessage("Thời gian nhắc nhở"),
    ...
    "restart_and_sign_in": MessageLookupByLibrary.simpleMessage(
      "3. Khởi động lại",
    ),
    "restore": MessageLookupByLibrary.simpleMessage("Khôi phục"),
    "restore_your_data_now": MessageLookupByLibrary.simpleMessage(
      "Khôi phục dữ liệu của bạn bây giờ?",
    ),
    ...
    "sync_completed": MessageLookupByLibrary.simpleMessage("Đồng bộ hoàn tất"),
    "sync_error": MessageLookupByLibrary.simpleMessage(
      "Lỗi! Vui lòng thử lại sau",
    ),
    "sync_to_drive": MessageLookupByLibrary.simpleMessage(
      "1. Đồng bộ dữ liệu vào Google Drive của bạn",
    ),
    "syncing_data": MessageLookupByLibrary.simpleMessage(
    ...
    "test_results": MessageLookupByLibrary.simpleMessage(
    ...
    "widgetStep2": MessageLookupByLibrary.simpleMessage("2. Nhấn vào Widget."),
