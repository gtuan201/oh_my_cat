            ...
            child: Row(
              children: [
                ...
                ? Container(
                  ...
                  child: Assets.image.drive.svg(width: 50,height: 50,fit: BoxFit.cover),
                )
                : CircleAvatar(
                  radius: 36,
                  backgroundImage: NetworkImage(backupProvider.currentUser?.photoUrl ?? ''),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(backupProvider.currentUser == null ?
                        "Sao lưu vào Google Drive" : backupProvider.currentUser?.displayName ?? '',
                        style: const TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.w800),
                      ),
                      const SizedBox(height: 8,),
                      Text(backupProvider.currentUser == null ?
                      "Nhấn để kết nối tài khoản" : backupProvider.currentUser?.email ?? '',
                ...
                IconButton(
                  onPressed: (){
                    showConfirmationDialog(context,
                        icon: Assets.image.logout.svg(width: 40,height: 40),
                        title: "Đăng xuất",
